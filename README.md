...
* [./PlanCare](./PlanCare) is a ASP.NET API with a [CarController](./PlanCare/CarController.cs) that provides a list of [cars](./PlanCare/Model/Car.cs). It has a SignalR [background service](./PlanCare/RegoBackgroundService.cs) that updates clients with car registration statuses.
